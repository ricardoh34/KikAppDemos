...
$url= "http://demo.kikapptools.com/CRMManager/crud/addCompany.php";

$inputJSON = file_get_contents('php://input');
$input= json_decode( $inputJSON, TRUE ); //convert JSON into array

$data = array("CompanyName"=>$input["name"],"CompanyAddress"=>$input["address"],"CompanyPhone"=>$input["phone"],"CompanyImage"=>$input["image"]);
$merge = array();
